...
\begin{frame}{E-Mails entschlüsseln}
  \begin{center}
  \includegraphics[width=.8\textwidth]{img-src/pgp_dec.png}
  \end{center}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \begin{frame}{Ausblick – Schutzziele bei PGP}
  \begin{itemize}
   ...
   \item[$\square$\scalebox{1.25}{~}] Integrität (keine Veränderung) \visible<3->{$\rightarrow$ \textbf{Signatur notwendig}}
...
%    \item[$\square$\visible<4->{\hspace{-.67em}\raisebox{0.1em}{\scalebox{1.3}{\checkmark}}}] Verfügbarkeit
   \item[$\square$\scalebox{1.25}{~}] Verfügbarkeit
  \end{itemize}
  \pause
  \pause
